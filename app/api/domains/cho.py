    ...
    return HTMLResponse(
        ...
        + "<br>".join(
            (
                ...
                f"You're on QuanTrieuPCYT's osu! server"
...
WELCOME_MSG = "\n".join(
    (
        f"Welcome to QuanTrieuPCYT's osu! server!",
        "To see a list of commands, use !help.",
        "Join ThiccMC at [ThiccMC](https://qtpc.tech/discord)",
        "Have fun playing!",
    ),
)
...
RESTRICTED_MSG = (
    ...
    "greater than 3 months, you may appeal by sending a private "
    "message to qtpctechhxd#7317 on Discord "
)

WELCOME_NOTIFICATION = app.packets.notification(
    #f"Welcome back to {BASE_DOMAIN}!\nRunning bancho.py v{app.settings.VERSION}.",
    f"Welcome back! Have fun playing!",
)
